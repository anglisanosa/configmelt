...
def get_version() -> float:
    ...
    version_file = os.path.join(
        PKG_ROOT, 'configmelt', '_version.py'
    )
...
def get_package_data_files(pattern: str) -> List[str]:
    ...
    path = os.path.join(PKG_ROOT, 'configmelt')
...
setup(
    ...
    # url='https://github.com/anglisano/configmelt.git',
    description='open yml or json files',
    ...
    python_requires='>=3.8',
    project_urls={
        'Documentation': 'https://anglisanosa.github.io/configmelt/',
        'Bug Reports': 'https://github.com/anglisanosa/configmelt/issues',
        'Source': 'https://github.com/anglisanosa/configmelt',
    },
    license='',
)